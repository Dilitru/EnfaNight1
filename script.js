...
const questions = [
  {
    question:
      "1. Which of the following statements about CS-born babies and nutrition is true?",
    answers: [
      "A. CS delivery may impact gut microbiome diversity at birth",
      "B. Lower exposure to beneficial bacteria may lead to short and long-term diseases",
      "C. Gut dysbiosis may persist up to 7 years old",
      "D. All of the above",
    ],
  ...
  {
    question:
      "2. What nutrients, only found in Enfa A+, support higher-level cognitive skills for A+ Children?",
    answers: ["A. MFGM + DHA", "B. HMO", "C. 2’-FL"],
    correct: "A. MFGM + DHA",
  },
  {
    question:
      "3. A baby is fussy, gassy, and excessively crying. Which benefit helps support them?",
    answers: [
      "A. Helps shorten diarrhea caused by lactose intolerance",
      "B. All-in-One Comfort formula with rapid digestive discomfort relief within 24 hours",
      "C. Helps support stronger immunity with 2'-FL HMO",
      "D. All of the above",
    ],
  ...
  {
    question:
      "4. A partially hydrolyzed formula with low lactose and MFGM + DHA is clinically proven to:",
    answers: [
      "A. Provide rapid digestive discomfort relief within 24 hours",
      "B. Support easier digestion vs. standard milk formula",
      "C. Support higher level cognitive skills",
      "D. All of the above",
    ],
    correct: "D. All of the above",
  },
  {
    question:
      "5. Early supplementation of MFGM+DHA are clinically proven to do which of the following?",
    answers: [
      "A. Accelerate early milestones",
      "B. Support long term brain benefits (ex. executive function)",
      "C. Support faster myelination and improved cognition",
      "D. All of the above",
    ],
    correct: "D. All of the above",
  },
  {
    question:
      "6. What nutrients can help support gut microbiome diversity for CS-born babies and children?",
...
const firebaseConfig = {
  ...
  databaseURL:
    "https://quizapp-cf724-default-rtdb.asia-southeast1.firebasedatabase.app",
...
let questionStatus = [true, true, true, true, true, true];
...
function renderQuestion(index) {
  ...
  // Clear container
  container.innerHTML = `<h3 style="text-align: center;">QUESTION ${index + 1}<span hidden>${q.question}</span></h3>`;
...
function checkAnswer(index, selected) {
  ...
  if (selected == questions[index].correct) {
    ...
    console.log("correct answer, sent to db");
  } else {
    console.log("wrong answer, doing nothing");
  }
...
function sendQuestionCompletion() {
  ...
  console.log(
    "LocalStorage values → tableNumber:",
    tableNumber,
    "questionNumber:",
    questionNumber,
  );
